...
-- ----------------------------
-- Table structure for spider_users_roles
-- ----------------------------
DROP TABLE IF EXISTS `spider_users_roles`;
CREATE TABLE `spider_users_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `spider_users_roles_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `spider_users_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of spider_users_roles
-- ----------------------------
INSERT INTO `spider_users_roles` VALUES ('1', '2', 'superadmin', 'مدیریت کل', 'توضیحات', '5', '6');
INSERT INTO `spider_users_roles` VALUES ('2', '3', 'registered', 'کاربران ثبت نام شده', 'کاربران ثبت نام شده', '2', '7');
INSERT INTO `spider_users_roles` VALUES ('3', null, 'public', 'کاربران عمومی', '', '1', '8');
INSERT INTO `spider_users_roles` VALUES ('4', '2', 'admin', 'مدیر', '', '3', '4');
...
-- ----------------------------
-- Table structure for spider_users_users_roles
-- ----------------------------
DROP TABLE IF EXISTS `spider_users_users_roles`;
CREATE TABLE `spider_users_users_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Records of spider_users_users_roles
-- ----------------------------
INSERT INTO `spider_users_users_roles` VALUES ('1', '1', '1');
